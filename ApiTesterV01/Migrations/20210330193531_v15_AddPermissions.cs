...
{
    public partial class v15_AddPermissions : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(64)", nullable: false),
                    AreaName = table.Column<string>(type: "nvarchar(64)", nullable: true),
                    ControllerName = table.Column<string>(type: "nvarchar(64)", nullable: true),
                    ActionName = table.Column<string>(type: "nvarchar(64)", nullable: true),
                    ActionType = table.Column<string>(type: "nvarchar(64)", nullable: false),
                    ShowInMenu = table.Column<bool>(type: "bit", nullable: false),
