...
namespace ApiTesterV01.Migrations
{
    ...
    [Migration("20210401081400_v16_actionTypeToSmallInt")]
    partial class v16_actionTypeToSmallInt
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiTesterV01.Entities.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApiTesterV01.Entities.PermissionGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApiTesterV01.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApiTesterV01.Entities.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApiTesterV01.Entities.Permission", b =>
                {
                    b.HasOne("ApiTesterV01.Entities.PermissionGroup", "PermissionGroup")
            ...
            modelBuilder.Entity("ApiTesterV01.Entities.RolePermission", b =>
                {
                    b.HasOne("ApiTesterV01.Entities.Permission", "Permission")
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiTesterV01.Entities.Role", "Role")
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("ApiTesterV01.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiTesterV01.Entities.User", null)
                        .WithMany()
